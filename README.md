...
4. Wait for a PR to be created.
    ...
    The PR will modify one or more of the basic charms (and possibly their unit tests or integration tests) in an attempt to disprove the documentation claim you described in the issue.
